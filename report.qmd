...
Debut rank and total weeks have a negative association, indicating that books with higher debut ranks don't always stay on the best seller list. According to the regression model, securing the top spot on the New York Times best-seller list requires remaining on the list for a greater number of weeks.
